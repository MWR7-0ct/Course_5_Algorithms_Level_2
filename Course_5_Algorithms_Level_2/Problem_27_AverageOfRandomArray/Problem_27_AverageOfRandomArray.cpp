...
int GetSumOfOfArray(int Arr[100], int ArrSize)
{
	int Sum = 0;
	for (int i = 0; i < ArrSize; i++)
	{
...
float GetAverageOfArray(int Arr[100], int ArrSize)
{
	return (float)GetSumOfOfArray(Arr, ArrSize) / ArrSize;
}
...
int main()
{
	...
	cout << "\nThe average of element in the array : " << endl;

	cout << GetAverageOfArray(Arr,ArrSize);
